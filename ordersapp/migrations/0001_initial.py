    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('STP', 'отправлен в обработку'), ('PRD', 'обрабатывается'), ('RDY', 'готов к выдаче'), ('PD', 'оплачен'), ('FM', 'формируется'), ('CNC', 'отменен')], default='FM', max_length=3, verbose_name='статус')),
